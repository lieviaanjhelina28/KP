 <!-- Begin Page Content -->
    ...
    <?php echo form_open_multipart('user/dosen/tambah'); ?>
      <div class="form-group">
        ...
        <input type="text" name="nama_dosen" class="form-control" id="nama_dosen" placeholder="Masukkan Nama" value="<?php echo $user['nama'];?>"  >
      </div>
     <div class="form-group">
        <label><b>NIK</b></label>
        <input type="text" name="NIK" class="form-control" id="NIK" placeholder="Masukkan NIK" value="<?php echo $user['NIK'];?>"  >
      </div>
      <div class="form-group">
        ...
        <input type="text" name="keperluan" class="form-control" id="keperluan" placeholder="untuk keperluan">
      </div>
      <div class="form-group">
