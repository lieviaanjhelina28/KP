 <!-- Begin Page Content -->
    ...
    <div class="container-fluid">
       <?= form_open('user/Mahasiswa'); ?>
        ...
        <input type="text" name="nama_mahasiswa" class="form-control" id="nama_mahasiswa" placeholder="Masukkan Nama" value="<?php echo $user['nama'];?>"  ><?php echo form_error('nama_mahasiswa',' <small class="text-danger pl-3">','</small> '); ?>
      </div>
      <div class="form-group">
...
<?php echo form_error('semester',' <small class="text-danger pl-3">','</small> '); ?>
      ...
      <div class="form-group">
        ...
        <input type="text" name="kebutuhan" class="form-control" id="kebutuhan" placeholder="Contoh : Surat Keterangan Aktif"  > 
        <?php echo form_error('kebutuhan',' <small class="text-danger pl-3">','</small> '); ?>
      </div>

         <div class="form-group">
        <label ><b>keperluan</b></label>
        <input type="text" name="keperluan" class="form-control" id="keperluan" placeholder="Contoh : Syarat Kolokium">
